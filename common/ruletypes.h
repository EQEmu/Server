...
RULE_BOOL(Character, UseOldBindWound, false, "Uses the original bind wound behaviour")
...
RULE_BOOL(Skills, UseLimitTradeskillSearchSkillDiff, true, "Enables the limit for the maximum difference between trivial and skill for recipe searches and favourites")
...
RULE_REAL(NPC, NPCHealOnGateAmount, 25, "How much the NCP will heal on gate if enabled")
RULE_CATEGORY_END()
