...
RULE_BOOL(Character, EnableLevelFirst, false, "If enabled, it sends server wide notification of user who obtained that level first.")
...
RULE_BOOL(Character, PVPFacingInMeleeRequired, false, "When set to false, pvp melee can attack 360 degrees instead of just front")
