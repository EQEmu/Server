...
RULE_REAL(Custom, RadiantItemDropRate, 25.0, "Percentage chance that a drop will be upgraded")
RULE_REAL(Custom, AwakenedItemDropRate, 50.0, "Percentage chance that a drop will be upgraded")
