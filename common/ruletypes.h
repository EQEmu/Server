...
RULE_BOOL(Character, MarqueeHPUpdates, false, "Will show Health percentage in center of screen < 100%")
...
RULE_BOOL(Character, AllowCrossClassTrainers, false, "<Description required>")
...
RULE_CATEGORY(Mercs)
RULE_INT(Mercs, SuspendIntervalMS, 10000, "Time interval for merc suspend in milliseconds.")
RULE_INT(Mercs, UpkeepIntervalMS, 180000, "Time interval for merc upkeep in milliseconds")
RULE_INT(Mercs, SuspendIntervalS, 10, "Time interval for merc suspend command in seconds")
...
RULE_INT(Zone, GraveyardTimeMS, 1200000, "Milliseconds time until a player corpse is moved to a zone's graveyard, if one is specified for the zone")
...
RULE_INT(Spells, AI_SpellCastFinishedFailRecast, 800, "AI spell recast time(milliseconds) when an spell is cast but fails (ie stunned)")
RULE_INT(Spells, AI_EngagedNoSpellMinRecast, 500, "AI spell recast time (milliseconds) check when no spell is cast while engaged. (min time in random)")
RULE_INT(Spells, AI_EngagedNoSpellMaxRecast, 1000, "AI spell recast time (milliseconds) check when no spell is cast engaged.(maximum time in random)")
...
RULE_INT(Spells, AI_PursueNoSpellMinRecast, 500, "AI spell recast time (milliseconds) check when no spell is cast while chasing target. (min time in random)")
RULE_INT(Spells, AI_PursueNoSpellMaxRecast, 2000, "AI spell recast time (milliseconds) check when no spell is cast while chasing target. (maximum time in random)")
RULE_INT(Spells, AI_PursueDetrimentalChance, 90, "Chance while chasing target to cast a detrimental spell")
RULE_INT(Spells, AI_IdleNoSpellMinRecast, 6000, "AI spell recast time (milliseconds) check when no spell is cast while idle. (min time in random)")
RULE_INT(Spells, AI_IdleNoSpellMaxRecast, 60000, "AI spell recast time (milliseconds) check when no spell is cast while chasing target. (maximum time in random)")
RULE_INT(Spells, AI_IdleBeneficialChance, 100, "Chance while idle to do a beneficial spell on self or others")
RULE_INT(Spells, AI_HealHPPct, 50, "Hitpoint percentage at which NPC starts healing when max_hp of the spell is not set ((nside and outside combat)")
...
RULE_BOOL(Combat, UseIntervalAC, true, "<Description required>")
...
RULE_REAL(Combat, NPCACFactor, 2.25, "<Description required>")
...
RULE_REAL(Combat, SoftcapFactor, 1.88, "<Description required>")
RULE_REAL(Combat, ACthac0Factor, 0.55, "<Description required>")
RULE_REAL(Combat, ACthac20Factor, 0.55, "<Description required>")
...
RULE_INT(NPC, CorpseUnlockTimer, 150000, "<Description required>")
RULE_INT(NPC, EmptyNPCCorpseDecayTimeMS, 0, "NPC corpse decay time, if no items are left on the corpse (milliseconds)")
RULE_BOOL(NPC, UseItemBonusesForNonPets, true, "<Description required>")
...
RULE_INT(NPC, SayPauseTimeInSec, 5, "<Description required>")
...
RULE_CATEGORY(Aggro)
RULE_BOOL(Aggro, SmartAggroList, true, "<Description required>")
...
RULE_BOOL(Chat, EnableMailKeyIPVerification, true, "<Description required>")
...
RULE_INT(Chat, MinimumMessagesPerInterval, 4, "<Description required>")
RULE_INT(Chat, MaximumMessagesPerInterval, 12, "<Description required>")
RULE_INT(Chat, MaxMessagesBeforeKick, 20, "<Description required>")
...
RULE_BOOL(Bazaar, AuditTrail, false, "<Description required>")
RULE_INT(Bazaar, MaxSearchResults, 50, "<Description required>")
RULE_BOOL(Bazaar, EnableWarpToTrader, true, "<Description required>")
...
RULE_INT(Network, ResendDelayBaseMS, 100, "<Description required>")
RULE_REAL(Network, ResendDelayFactor, 1.5, "<Description required>")
RULE_INT(Network, ResendDelayMinMS, 300, "<Description required>")
RULE_INT(Network, ResendDelayMaxMS, 5000, "<Description required>")
RULE_REAL(Network, ClientDataRate, 0.0, "KB / sec, 0.0 disabled")
RULE_BOOL(Network, CompressZoneStream, true, "<Description required>")
RULE_CATEGORY_END()
