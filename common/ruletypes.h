...
RULE_INT(Character, CorpseDecayTimeMS, 604800000, "Total Corpse Decay time in MS")
RULE_INT( Character, EmptyCorpseDecayTimeMS, 10800000, "Empty Corpse Decay time in MS")
RULE_INT(Character, CorpseResTimeMS, 10800000, "Time after which the corpse can no longer be resurrected (milliseconds)")
RULE_INT( Character, DuelCorpseResTimeMS, 600000,"Time before cant res corpse after a duel ")
