...
RULE_REAL(Character, RaidFlatExpMultiplier, 1.0, "The experience gained in raids is multiplied by this amount. Default is 1.0")
...
RULE_BOOL(Character, EnableRaidFlatEXPModifier, false, "Enable or disable the flat raid experience modifier, default is false. Supersedes Character:EnableRaidEXPModifier if enabled.")
