...
RULE_INT(Combat, PetAttackMagicLevel, 10, "Level at which pets can cause magic damage")
RULE_INT(Combat, NPCAttackMagicLevel, 10, "Level at which non-pet NPCs can cause magic damage")
