...
RULE_BOOL(Spells, EnableDOTDurationBonusSpread, true, "True:  Spell damage and focus effects are spread over DOT ticks.  False:  They are applied to every tick.")
RULE_BOOL(Spells, EnableHOTDurationBonusSpread, true, "True:  Heal Amount and focus effects are spread over HOT ticks.  False:  They are applied to every tick.")
