...
RULE_BOOL(Spells, UseFadingMemoriesMaxLevel, false, "Enables to max field in spell data to set the max level that over which an NPC will ignore fading memories effect and not lose aggro.")
RULE_CATEGORY_END()
