...
RULE_INT(Combat, ArcheryBaseDamage, 0, "Determines Archery Base Damage, default is 0")
RULE_INT(Combat, BackstabBaseDamage, 0, "Determines Backstab Base Damage, default is 0")
RULE_INT(Combat, BashBaseDamage, 2, "Determines Bash Base Damage, default is 2")
RULE_INT(Combat, DragonPunchBaseDamage, 12, "Determines Dragon Punch Base Damage, default is 12")
RULE_INT(Combat, EagleStrikeBaseDamage, 7, "Determines Eagle Strike Base Damage, default is 7")
RULE_INT(Combat, FlyingKickBaseDamage, 25, "Determines Flying Kick Base Damage, default is 25")
RULE_INT(Combat, FrenzyBaseDamage, 10, "Determines Frenzy Base Damage, default is 10")
RULE_INT(Combat, KickBaseDamage, 3, "Determines Kick Base Damage, default is 3")
RULE_INT(Combat, RoundKickBaseDamage, 5, "Determines Round Kick Base Damage, default is 5")
RULE_INT(Combat, ThrowingBaseDamage, 0, "Determines Throwing Base Damage, default is 0")
RULE_INT(Combat, TigerClawBaseDamage, 4, "Determines Tiger Claw Base Damage, default is 4")
RULE_CATEGORY_END()
