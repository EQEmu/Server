...
RULE_BOOL(Character, HeroicStatsUseDataBucketsToScale, false, "Allows scaling the benefits a character receives from Heroic Stats using Data Buckets. If enabled a Data Bucket with a positive value is required to gain any benefit from the stat, even with any Rule Mulitpliers applied.")
