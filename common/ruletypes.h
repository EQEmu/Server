...
RULE_REAL(Character, TradeskillUpAlchemy, 2, "Alchemy skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpBaking, 2, "Baking skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpBlacksmithing, 2, "Blacksmithing skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpBrewing, 3, "Brewing skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpFletching, 2, "Fletching skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpJewelcrafting, 2, "Jewelcrafting skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpMakePoison, 2, "Make Poison skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpPottery, 4, "Pottery skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpResearch, 1, "Research skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpTinkering, 2, "Tinkering skillup rate adjustment. Lower is faster")
RULE_REAL(Character, TradeskillUpTailoring, 2, "Tailoring skillup rate adjustment. Lower is faster")
