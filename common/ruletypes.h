...
RULE_INT(Zone, MQGhostExemptStatus, -1, "Required status level to exempt the MQGhostDetector. Set to -1 to disable this feature.")
RULE_INT(Zone, MQFastMemExemptStatus, -1, "Required status level to exempt the MQFastMemDetector. Set to -1 to disable this feature.")
RULE_INT(Zone, MQNoStunExemptStatus, -1, "Required status level to exempt the MQFastMemDetector. Set to -1 to disable this feature.")
...
RULE_BOOL(Zone, EnableMQFastMemDetector, true, "Enable the MQFastMem Detector. Set to False to disable this feature.")
RULE_BOOL(Zone, EnableMQNoStunDetector, true, "Enable the MQNoStun Detector. Set to False to disable this feature.")
RULE_BOOL(Zone, MarkMQWarpLT, false, "Mark clients makeing smaller warps")
RULE_BOOL(Zone, MQDetectionSilentReport, true, "Set this to False to announce to the player when a warp log entry was placed in.")
RULE_CATEGORY_END()
