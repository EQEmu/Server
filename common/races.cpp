...
uint16 EQ::races::GetPlayerRaceValue(uint16 race_id)
{
	switch (race_id) {
		...
		case Race::VahShir:
			return PlayerRace::VahShir;
		case Race::Froglok2:
			return PlayerRace::Froglok;
		case Race::Drakkin:
			return PlayerRace::Drakkin;
		default:
...
float EQ::races::GetRaceGenderDefaultHeight(uint16 race, uint8 gender)
{
...
#define VAHSHIR_MALE ((Race::VahShir << 8) | Gender::Male)
#define VAHSHIR_FEMALE ((Race::VahShir << 8) | Gender::Female)
#define FROGLOK_MALE ((Race::Froglok2 << 8) | Gender::Male)
#define FROGLOK_FEMALE ((Race::Froglok2 << 8) | Gender::Female)
