...
public:
     ...
     *
     * PlayerEventNpcHandinRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * PlayerEventNpcHandinRepository::GetWhereNeverExpires()
     * PlayerEventNpcHandinRepository::GetWhereXAndY()
     * PlayerEventNpcHandinRepository::DeleteWhereXAndY()
     *
