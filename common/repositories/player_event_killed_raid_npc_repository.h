...
public:
     ...
     *
     * PlayerEventKilledRaidNpcRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * PlayerEventKilledRaidNpcRepository::GetWhereNeverExpires()
     * PlayerEventKilledRaidNpcRepository::GetWhereXAndY()
     * PlayerEventKilledRaidNpcRepository::DeleteWhereXAndY()
     *
