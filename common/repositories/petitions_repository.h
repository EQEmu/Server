...
#ifndef EQEMU_PETITIONS_REPOSITORY_H
#define EQEMU_PETITIONS_REPOSITORY_H

#include "../database.h"
#include "../string_util.h"

class PetitionsRepository {
public:
	struct Petitions {
		int         dib;
		int         petid;
	...
	)
	{
		...
		if (results.Success()) {
			petitions_entry.id = results.LastInsertedID();
...
#endif //EQEMU_PETITIONS_REPOSITORY_H
