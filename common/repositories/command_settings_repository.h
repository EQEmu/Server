...
#include "base/base_command_settings_repository.h"
...
public:
     ...
     *
     * CommandSettingsRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * CommandSettingsRepository::GetWhereNeverExpires()
     * CommandSettingsRepository::GetWhereXAndY()
     * CommandSettingsRepository::DeleteWhereXAndY()
     *
