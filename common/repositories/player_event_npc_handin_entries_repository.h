...
public:
     ...
     *
     * PlayerEventNpcHandinEntriesRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * PlayerEventNpcHandinEntriesRepository::GetWhereNeverExpires()
     * PlayerEventNpcHandinEntriesRepository::GetWhereXAndY()
     * PlayerEventNpcHandinEntriesRepository::DeleteWhereXAndY()
     *
