...
public:
	struct SpellsNew {
		...
		int         classes15;
		int         classes16;
		int         casting_animation;
		int         TargetAnim;
		int         TravelType;
		int         spell_affect_index;
		int         disallow_sit;
		int         deities0;
		int         deities1;
		int         deities2;
		...
		int         allowrest;
		int         can_cast_in_combat;
		int         can_cast_out_of_combat;
		int         field215;
		int         field216;
		int         field217;
		int         aoe_max_targets;
	...
	static SpellsNew NewEntity()
	{
		...
		entry.recast_time          = 0;
		entry.buff_duration_formula  = 7;
		entry.buff_duration         = 65;
		entry.aoe_duration           = 0;
		entry.mana                 = 0;
		...
		entry.target_type           = 2;
		entry.base_difficulty             = 0;
		entry.skill                = 98;
		entry.zone_type             = -1;
		entry.environment_type      = 0;
		entry.time_of_day            = 0;
		entry.classes1             = 255;
		entry.classes2             = 255;
		entry.classes3             = 255;
		...
		entry.classes15            = 255;
		entry.classes16            = 255;
		entry.casting_animation          = 44;
		entry.TargetAnim           = 13;
		entry.TravelType           = 0;
		entry.spell_affect_index     = -1;
		...
		entry.resist_difficulty           = -150;
		entry.unstackable_dot  = 0;
		entry.deleteable           = 0;
		entry.recourse_link         = 0;
		entry.no_partial_resist    = 0;
		entry.field152             = 0;
		entry.field153             = 0;
		entry.short_buff_box       = -1;
		entry.description_id              = 0;
		entry.type_description_id          = 0;
		entry.effect_description_id        = 0;
		...
		entry.field172             = 0;
		entry.hate_added            = 0;
		entry.endurance_upkeep          = 0;
		entry.hit_number_type          = 0;
		entry.hit_number              = 0;
		entry.pvp_resist_base        = -150;
		...
		entry.field209             = 0;
		entry.field210             = 1;
		entry.cast_restriction      = 0;
		entry.allowrest            = 0;
		entry.can_cast_in_combat             = 0;
		entry.can_cast_out_of_combat          = 0;
		entry.field215             = 0;
		entry.field216             = 0;
		entry.field217             = 0;
		entry.aoe_max_targets         = 0;
		entry.maxtargets           = 0;
		entry.field220             = 0;
		entry.field221             = 0;
		entry.field222             = 0;
		entry.field223             = 0;
		entry.persist_death         = 0;
		entry.field225             = 0;
		entry.field226             = 0;
		entry.min_distance             = 0;
		entry.min_distance_mod         = 0;
		entry.max_distance             = 0;
		entry.max_distance_mod         = 0;
		entry.min_range            = 0;
		entry.field232             = 0;
		entry.field233             = 0;
		entry.field234             = 0;
	...
	)
	{
		...
		if (results.RowCount() == 1) {
			...
			entry.aoe_range             = atoi(row[10]);
			entry.push_back             = atoi(row[11]);
			entry.push_up               = atoi(row[12]);
			entry.cast_time            = atoi(row[13]);
			entry.recovery_time        = atoi(row[14]);
			entry.recast_time          = atoi(row[15]);
			entry.buff_duration_formula  = atoi(row[16]);
			entry.buff_duration         = atoi(row[17]);
			entry.aoe_duration           = atoi(row[18]);
			...
			entry.good_effect           = atoi(row[83]);
			entry.activated            = atoi(row[84]);
			entry.resist_type           = atoi(row[85]);
			...
			entry.target_type           = atoi(row[98]);
			entry.base_difficulty             = atoi(row[99]);
			entry.skill                = atoi(row[100]);
			entry.zone_type             = atoi(row[101]);
			entry.environment_type      = atoi(row[102]);
			entry.time_of_day            = atoi(row[103]);
			...
			entry.casting_animation          = atoi(row[120]);
			entry.TargetAnim           = atoi(row[121]);
			entry.TravelType           = atoi(row[122]);
			entry.spell_affect_index     = atoi(row[123]);
			...
			entry.resist_difficulty           = atoi(row[147]);
			entry.unstackable_dot  = atoi(row[148]);
			entry.deleteable           = atoi(row[149]);
			entry.recourse_link         = atoi(row[150]);
			...
			entry.hate_added            = atoi(row[173]);
			entry.endurance_upkeep          = atoi(row[174]);
			entry.hit_number_type          = atoi(row[175]);
			entry.hit_number              = atoi(row[176]);
			entry.pvp_resist_base        = atoi(row[177]);
			...
			entry.min_resist            = atoi(row[189]);
			entry.max_resist            = atoi(row[190]);
			...
			entry.persist_death         = atoi(row[224]);
			entry.field225             = atoi(row[225]);
			entry.field226             = atoi(row[226]);
			entry.min_distance             = static_cast<float>(atof(row[227]));
			entry.min_distance_mod         = static_cast<float>(atof(row[228]));
			entry.max_distance             = static_cast<float>(atof(row[229]));
			entry.max_distance_mod         = static_cast<float>(atof(row[230]));
	...
	)
	{
		...
		update_values.push_back(columns[10] + " = " + std::to_string(spells_new_entry.aoe_range));
		update_values.push_back(columns[11] + " = " + std::to_string(spells_new_entry.push_back));
		update_values.push_back(columns[12] + " = " + std::to_string(spells_new_entry.push_up));
		...
		update_values.push_back(columns[16] + " = " + std::to_string(spells_new_entry.buff_duration_formula));
		update_values.push_back(columns[17] + " = " + std::to_string(spells_new_entry.buff_duration));
		update_values.push_back(columns[18] + " = " + std::to_string(spells_new_entry.aoe_duration));
		...
		update_values.push_back(columns[83] + " = " + std::to_string(spells_new_entry.good_effect));
		update_values.push_back(columns[84] + " = " + std::to_string(spells_new_entry.activated));
		update_values.push_back(columns[85] + " = " + std::to_string(spells_new_entry.resist_type));
		...
		update_values.push_back(columns[98] + " = " + std::to_string(spells_new_entry.target_type));
		update_values.push_back(columns[99] + " = " + std::to_string(spells_new_entry.base_difficulty));
		update_values.push_back(columns[100] + " = " + std::to_string(spells_new_entry.skill));
		update_values.push_back(columns[101] + " = " + std::to_string(spells_new_entry.zone_type));
		update_values.push_back(columns[102] + " = " + std::to_string(spells_new_entry.environment_type));
		update_values.push_back(columns[103] + " = " + std::to_string(spells_new_entry.time_of_day));
		...
		update_values.push_back(columns[120] + " = " + std::to_string(spells_new_entry.casting_animation));
		...
		update_values.push_back(columns[123] + " = " + std::to_string(spells_new_entry.spell_affect_index));
		...
		update_values.push_back(columns[147] + " = " + std::to_string(spells_new_entry.resist_difficulty));
		update_values.push_back(columns[148] + " = " + std::to_string(spells_new_entry.unstackable_dot));
		update_values.push_back(columns[149] + " = " + std::to_string(spells_new_entry.deleteable));
		update_values.push_back(columns[150] + " = " + std::to_string(spells_new_entry.recourse_link));
		...
		update_values.push_back(columns[155] + " = " + std::to_string(spells_new_entry.description_id));
		update_values.push_back(columns[156] + " = " + std::to_string(spells_new_entry.type_description_id));
		update_values.push_back(columns[157] + " = " + std::to_string(spells_new_entry.effect_description_id));
		...
		update_values.push_back(columns[162] + " = " + std::to_string(spells_new_entry.bonus_hate));
		...
		update_values.push_back(columns[166] + " = " + std::to_string(spells_new_entry.endurance_cost));
		update_values.push_back(columns[167] + " = " + std::to_string(spells_new_entry.timer_id));
		...
		update_values.push_back(columns[173] + " = " + std::to_string(spells_new_entry.hate_added));
		update_values.push_back(columns[174] + " = " + std::to_string(spells_new_entry.endurance_upkeep));
		update_values.push_back(columns[175] + " = " + std::to_string(spells_new_entry.hit_number_type));
		update_values.push_back(columns[176] + " = " + std::to_string(spells_new_entry.hit_number));
		update_values.push_back(columns[177] + " = " + std::to_string(spells_new_entry.pvp_resist_base));
		...
		update_values.push_back(columns[189] + " = " + std::to_string(spells_new_entry.min_resist));
		update_values.push_back(columns[190] + " = " + std::to_string(spells_new_entry.max_resist));
		...
		update_values.push_back(columns[202] + " = " + std::to_string(spells_new_entry.song_cap));
		...
		update_values.push_back(columns[207] + " = " + std::to_string(spells_new_entry.spell_group));
		...
		update_values.push_back(columns[211] + " = " + std::to_string(spells_new_entry.cast_restriction));
		update_values.push_back(columns[212] + " = " + std::to_string(spells_new_entry.allowrest));
		update_values.push_back(columns[213] + " = " + std::to_string(spells_new_entry.can_cast_in_combat));
		update_values.push_back(columns[214] + " = " + std::to_string(spells_new_entry.can_cast_out_of_combat));
		...
		update_values.push_back(columns[218] + " = " + std::to_string(spells_new_entry.aoe_max_targets));
		...
		update_values.push_back(columns[224] + " = " + std::to_string(spells_new_entry.persist_death));
		...
		update_values.push_back(columns[227] + " = " + std::to_string(spells_new_entry.min_distance));
		update_values.push_back(columns[228] + " = " + std::to_string(spells_new_entry.min_distance_mod));
		update_values.push_back(columns[229] + " = " + std::to_string(spells_new_entry.max_distance));
		update_values.push_back(columns[230] + " = " + std::to_string(spells_new_entry.max_distance_mod));
	...
	)
	{
		...
		insert_values.push_back(std::to_string(spells_new_entry.aoe_range));
		insert_values.push_back(std::to_string(spells_new_entry.push_back));
		insert_values.push_back(std::to_string(spells_new_entry.push_up));
		...
		insert_values.push_back(std::to_string(spells_new_entry.buff_duration_formula));
		insert_values.push_back(std::to_string(spells_new_entry.buff_duration));
		insert_values.push_back(std::to_string(spells_new_entry.aoe_duration));
		...
		insert_values.push_back(std::to_string(spells_new_entry.good_effect));
		insert_values.push_back(std::to_string(spells_new_entry.activated));
		insert_values.push_back(std::to_string(spells_new_entry.resist_type));
		...
		insert_values.push_back(std::to_string(spells_new_entry.target_type));
		insert_values.push_back(std::to_string(spells_new_entry.base_difficulty));
		insert_values.push_back(std::to_string(spells_new_entry.skill));
		insert_values.push_back(std::to_string(spells_new_entry.zone_type));
		insert_values.push_back(std::to_string(spells_new_entry.environment_type));
		insert_values.push_back(std::to_string(spells_new_entry.time_of_day));
		...
		insert_values.push_back(std::to_string(spells_new_entry.casting_animation));
		...
		insert_values.push_back(std::to_string(spells_new_entry.spell_affect_index));
		...
		insert_values.push_back(std::to_string(spells_new_entry.resist_difficulty));
		insert_values.push_back(std::to_string(spells_new_entry.unstackable_dot));
		insert_values.push_back(std::to_string(spells_new_entry.deleteable));
		insert_values.push_back(std::to_string(spells_new_entry.recourse_link));
		...
		insert_values.push_back(std::to_string(spells_new_entry.description_id));
		insert_values.push_back(std::to_string(spells_new_entry.type_description_id));
		insert_values.push_back(std::to_string(spells_new_entry.effect_description_id));
		...
		insert_values.push_back(std::to_string(spells_new_entry.bonus_hate));
		...
		insert_values.push_back(std::to_string(spells_new_entry.endurance_cost));
		insert_values.push_back(std::to_string(spells_new_entry.timer_id));
		...
		insert_values.push_back(std::to_string(spells_new_entry.hate_added));
		insert_values.push_back(std::to_string(spells_new_entry.endurance_upkeep));
		insert_values.push_back(std::to_string(spells_new_entry.hit_number_type));
		insert_values.push_back(std::to_string(spells_new_entry.hit_number));
		insert_values.push_back(std::to_string(spells_new_entry.pvp_resist_base));
		...
		insert_values.push_back(std::to_string(spells_new_entry.min_resist));
		insert_values.push_back(std::to_string(spells_new_entry.max_resist));
		...
		insert_values.push_back(std::to_string(spells_new_entry.song_cap));
		...
		insert_values.push_back(std::to_string(spells_new_entry.spell_group));
		...
		insert_values.push_back(std::to_string(spells_new_entry.cast_restriction));
		insert_values.push_back(std::to_string(spells_new_entry.allowrest));
		insert_values.push_back(std::to_string(spells_new_entry.can_cast_in_combat));
		insert_values.push_back(std::to_string(spells_new_entry.can_cast_out_of_combat));
		...
		insert_values.push_back(std::to_string(spells_new_entry.aoe_max_targets));
		...
		insert_values.push_back(std::to_string(spells_new_entry.persist_death));
		...
		insert_values.push_back(std::to_string(spells_new_entry.min_distance));
		insert_values.push_back(std::to_string(spells_new_entry.min_distance_mod));
		insert_values.push_back(std::to_string(spells_new_entry.max_distance));
		insert_values.push_back(std::to_string(spells_new_entry.max_distance_mod));
