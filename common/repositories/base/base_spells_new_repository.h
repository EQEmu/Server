...
public:
	struct SpellsNew {
		...
		int32_t     no_detrimental_spell_aggro;
		int32_t     field199;
		int32_t     suspendable;
		int32_t     viral_range;
		int32_t     songcap;
		...
		int32_t     field215;
		int32_t     field216;
		int32_t     override_crit_chance;
		int32_t     aemaxtargets;
		int32_t     maxtargets;
		int32_t     no_heal_damage_item_mod;
		int32_t     caster_requirement_id;
		int32_t     spell_class;
		int32_t     spell_subclass;
	...
	static SpellsNew NewEntity()
	{
		...
		e.sneaking                   = 0;
		e.not_extendable             = 0;
		e.no_detrimental_spell_aggro = 0;
		e.field199                   = 1;
		e.suspendable                = 0;
		e.viral_range                = 0;
		e.songcap                    = 0;
		...
		e.field215                   = 0;
		e.field216                   = 0;
		e.override_crit_chance       = 0;
		e.aemaxtargets               = 0;
		e.maxtargets                 = 0;
		e.no_heal_damage_item_mod    = 0;
		e.caster_requirement_id      = 0;
		e.spell_class                = 0;
		e.spell_subclass             = 0;
		e.persistdeath               = 0;
		e.field225                   = 0;
	...
	)
	{
		...
		if (results.RowCount() == 1) {
			...
			e.feedbackable               = row[160] ? static_cast<int32_t>(atoi(row[160])) : 0;
			...
			e.no_detrimental_spell_aggro = row[198] ? static_cast<int32_t>(atoi(row[198])) : 0;
			...
			e.no_resist                  = row[209] ? static_cast<int32_t>(atoi(row[209])) : 0;
			...
			e.override_crit_chance       = row[217] ? static_cast<int32_t>(atoi(row[217])) : 0;
			e.aemaxtargets               = row[218] ? static_cast<int32_t>(atoi(row[218])) : 0;
			e.maxtargets                 = row[219] ? static_cast<int32_t>(atoi(row[219])) : 0;
			e.no_heal_damage_item_mod    = row[220] ? static_cast<int32_t>(atoi(row[220])) : 0;
			e.caster_requirement_id      = row[221] ? static_cast<int32_t>(atoi(row[221])) : 0;
			e.spell_class                = row[222] ? static_cast<int32_t>(atoi(row[222])) : 0;
			e.spell_subclass             = row[223] ? static_cast<int32_t>(atoi(row[223])) : 0;
			...
			e.no_remove                  = row[232] ? static_cast<int32_t>(atoi(row[232])) : 0;
	...
	)
	{
		...
		v.push_back(columns[160] + " = " + std::to_string(e.feedbackable));
		...
		v.push_back(columns[198] + " = " + std::to_string(e.no_detrimental_spell_aggro));
		...
		v.push_back(columns[209] + " = " + std::to_string(e.no_resist));
		...
		v.push_back(columns[217] + " = " + std::to_string(e.override_crit_chance));
		v.push_back(columns[218] + " = " + std::to_string(e.aemaxtargets));
		v.push_back(columns[219] + " = " + std::to_string(e.maxtargets));
		v.push_back(columns[220] + " = " + std::to_string(e.no_heal_damage_item_mod));
		v.push_back(columns[221] + " = " + std::to_string(e.caster_requirement_id));
		v.push_back(columns[222] + " = " + std::to_string(e.spell_class));
		v.push_back(columns[223] + " = " + std::to_string(e.spell_subclass));
		...
		v.push_back(columns[232] + " = " + std::to_string(e.no_remove));
	...
	)
	{
		...
		v.push_back(std::to_string(e.feedbackable));
		...
		v.push_back(std::to_string(e.no_detrimental_spell_aggro));
		...
		v.push_back(std::to_string(e.no_resist));
		...
		v.push_back(std::to_string(e.override_crit_chance));
		v.push_back(std::to_string(e.aemaxtargets));
		v.push_back(std::to_string(e.maxtargets));
		v.push_back(std::to_string(e.no_heal_damage_item_mod));
		v.push_back(std::to_string(e.caster_requirement_id));
		v.push_back(std::to_string(e.spell_class));
		v.push_back(std::to_string(e.spell_subclass));
		...
		v.push_back(std::to_string(e.no_remove));
