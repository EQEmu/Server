...
public:
	...
	)
	{
		...
		update_values.push_back(columns[1] + " = " + std::to_string(e.currency_id));
	...
	)
	{
		...
		insert_values.push_back(std::to_string(e.currency_id));
	...
	static int InsertMany(
		Database& db,
		std::vector<CharacterAltCurrency> entries
	)
	{
