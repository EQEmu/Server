...
public:
     ...
     *
     * PlayerEventKilledNpcRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * PlayerEventKilledNpcRepository::GetWhereNeverExpires()
     * PlayerEventKilledNpcRepository::GetWhereXAndY()
     * PlayerEventKilledNpcRepository::DeleteWhereXAndY()
     *
