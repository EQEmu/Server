...
#include "base/base_launcher_zones_repository.h"
...
public:
     ...
     *
     * LauncherZonesRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * LauncherZonesRepository::GetWhereNeverExpires()
     * LauncherZonesRepository::GetWhereXAndY()
     * LauncherZonesRepository::DeleteWhereXAndY()
     *
