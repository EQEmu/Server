...
public:
     ...
     *
     * ZoneStateSpawnsRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * ZoneStateSpawnsRepository::GetWhereNeverExpires()
     * ZoneStateSpawnsRepository::GetWhereXAndY()
     * ZoneStateSpawnsRepository::DeleteWhereXAndY()
     *
