...
public:
     ...
     *
     * PlayerEventSpeechRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * PlayerEventSpeechRepository::GetWhereNeverExpires()
     * PlayerEventSpeechRepository::GetWhereXAndY()
     * PlayerEventSpeechRepository::DeleteWhereXAndY()
     *
