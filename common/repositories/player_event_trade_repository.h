...
public:
     ...
     *
     * PlayerEventTradeRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * PlayerEventTradeRepository::GetWhereNeverExpires()
     * PlayerEventTradeRepository::GetWhereXAndY()
     * PlayerEventTradeRepository::DeleteWhereXAndY()
     *
