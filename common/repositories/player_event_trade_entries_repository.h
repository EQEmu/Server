...
public:
     ...
     *
     * PlayerEventTradeEntriesRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * PlayerEventTradeEntriesRepository::GetWhereNeverExpires()
     * PlayerEventTradeEntriesRepository::GetWhereXAndY()
     * PlayerEventTradeEntriesRepository::DeleteWhereXAndY()
     *
