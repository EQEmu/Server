...
public:
     ...
     *
     * CharacterPetNameRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * CharacterPetNameRepository::GetWhereNeverExpires()
     * CharacterPetNameRepository::GetWhereXAndY()
     * CharacterPetNameRepository::DeleteWhereXAndY()
     *
