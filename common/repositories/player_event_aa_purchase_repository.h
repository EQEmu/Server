...
public:
     ...
     *
     * PlayerEventAaPurchaseRepository::GetByZoneAndVersion(int zone_id, int zone_version)
     * PlayerEventAaPurchaseRepository::GetWhereNeverExpires()
     * PlayerEventAaPurchaseRepository::GetWhereXAndY()
     * PlayerEventAaPurchaseRepository::DeleteWhereXAndY()
     *
