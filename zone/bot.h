...
public:
	...
	virtual bool CastSpell(uint16 spell_id, uint16 target_id, uint8 slot = 10, int32 casttime = -1, int32 mana_cost = -1, uint32* oSpellWillFinish = 0, uint32 item_slot = 0xFFFFFFFF, int16 *resist_adjust = nullptr);
