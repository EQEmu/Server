...
{
	enum : uint8 { nHS = 0, pH, pS, pHS, cntHS}; // negative Healer/Slower, positive Healer, postive Slower, positive Healer/Slower
	
	static const uint8 spell_casting_chances[MaxSpellTypes][PLAYER_CLASS_COUNT][MaxStances][cntHS] = {
// SpellType_NukeIndex
		{
			{// WarriorIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Balanced { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Efficient { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Reactive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Aggressive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Burn { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// ClericIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 15, 25, 15 }, // Balanced { nHS, pH, pS, pHS }
				{ 15, 0, 15, 0 }, // Efficient { nHS, pH, pS, pHS }
				{ 25, 15, 25, 15 }, // Reactive { nHS, pH, pS, pHS }
				{ 50, 15, 50, 15 }, // Aggressive { nHS, pH, pS, pHS }
				{ 50, 25, 50, 25 }, // Burn { nHS, pH, pS, pHS }
				{ 50, 25, 50, 25 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// PaladinIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 15, 25, 15 }, // Balanced { nHS, pH, pS, pHS }
			...
			{// RangerIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 15, 15, 15, 15 }, // Balanced { nHS, pH, pS, pHS }
				{ 5, 5, 5, 5 }, // Efficient { nHS, pH, pS, pHS }
				{ 15, 15, 15, 15 }, // Reactive { nHS, pH, pS, pHS }
				{ 15, 15, 15, 15 }, // Aggressive { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 }, // Burn { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// ShadowknightIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 15, 15, 15, 15 }, // Balanced { nHS, pH, pS, pHS }
			...
			{// BardIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 }, // Balanced { nHS, pH, pS, pHS }
				{ 25, 25, 25, 25 }, // Efficient { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 }, // Reactive { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 }, // Aggressive { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 }, // Burn { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// RogueIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Balanced { nHS, pH, pS, pHS }
			...
			{// ShamanIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 15, 10, 5, 0 }, // Balanced { nHS, pH, pS, pHS }
				{ 10, 5, 0, 0 }, // Efficient { nHS, pH, pS, pHS }
				{ 15, 10, 5, 0 }, // Reactive { nHS, pH, pS, pHS }
				{ 25, 15, 15, 5 }, // Aggressive { nHS, pH, pS, pHS }
				{ 50, 25, 25, 15 }, // Burn { nHS, pH, pS, pHS }
				{ 50, 25, 25, 15 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// NecromancerIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 15, 15, 15, 15 }, // Balanced { nHS, pH, pS, pHS }
			...
			{// WizardIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 75, 75, 75, 75 }, // Balanced { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 }, // Efficient { nHS, pH, pS, pHS }
				{ 75, 75, 75, 75 }, // Reactive { nHS, pH, pS, pHS }
				{ 75, 75, 75, 75 }, // Aggressive { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 }, // Burn { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// MagicianIndex
			...
			{// EnchanterIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 25, 15, 15 }, // Balanced { nHS, pH, pS, pHS }
				{ 15, 15, 0, 0 }, // Efficient { nHS, pH, pS, pHS }
				{ 25, 25, 15, 15 }, // Reactive { nHS, pH, pS, pHS }
				{ 50, 50, 15, 15 }, // Aggressive { nHS, pH, pS, pHS }
				{ 50, 50, 25, 25 }, // Burn { nHS, pH, pS, pHS }
				{ 50, 50, 25, 25 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// BeastlordIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 15, 10, 5, 0 }, // Balanced { nHS, pH, pS, pHS }
...
// SpellType_HealIndex
		{
			...
			{// ClericIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 }, // Balanced { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 }, // Efficient { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 }, // Reactive { nHS, pH, pS, pHS }
				{ 75, 75, 75, 75 }, // Aggressive { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 }, // Burn { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// PaladinIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 100, 25, 100 }, // Balanced { nHS, pH, pS, pHS }
				{ 15, 75, 15, 75 }, // Efficient { nHS, pH, pS, pHS }
				{ 25, 100, 25, 100 }, // Reactive { nHS, pH, pS, pHS }
				{ 15, 75, 15, 75 }, // Aggressive { nHS, pH, pS, pHS }
				{ 0, 50, 0, 50 }, // Burn { nHS, pH, pS, pHS }
				{ 0, 50, 0, 50 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// RangerIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 100, 25, 100 }, // Balanced { nHS, pH, pS, pHS }
			...
			{// ShadowknightIndex
				...
				{ 25, 25, 25, 25 }, // Efficient { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 }, // Reactive { nHS, pH, pS, pHS }
				{ 25, 25, 25, 25 }, // Aggressive { nHS, pH, pS, pHS }
				{ 15, 15, 15, 15 }, // Burn { nHS, pH, pS, pHS }
				{ 15, 15, 15, 15 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// DruidIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 100, 25, 100 }, // Balanced { nHS, pH, pS, pHS }
				{ 15, 100, 15, 100 }, // Efficient { nHS, pH, pS, pHS }
				{ 25, 100, 25, 100 }, // Reactive { nHS, pH, pS, pHS }
				{ 25, 75, 25, 75 }, // Aggressive { nHS, pH, pS, pHS }
				{ 10, 50, 10, 50 }, // Burn { nHS, pH, pS, pHS }
				{ 10, 50, 10, 50 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// MonkIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Balanced { nHS, pH, pS, pHS }
			...
			{// NecromancerIndex
				...
				{ 100, 100, 100, 100 }, // Reactive { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 }, // Aggressive { nHS, pH, pS, pHS }
				{ 25, 25, 25, 25 }, // Burn { nHS, pH, pS, pHS }
				{ 25, 25, 25, 25 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// WizardIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Balanced { nHS, pH, pS, pHS }
...
// SpellType_EscapeIndex
		{
			...
			{// PaladinIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 25, 25, 25 }, // Balanced { nHS, pH, pS, pHS }
				{ 15, 15, 15, 15 }, // Efficient { nHS, pH, pS, pHS }
				{ 25, 25, 25, 25 }, // Reactive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Aggressive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Burn { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 } // BurnAE { nHS, pH, pS, pHS }
			},
...
// SpellType_PetIndex
		{
			...
			{// ShadowknightIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 25, 25, 25 }, // Balanced { nHS, pH, pS, pHS }
				{ 10, 10, 10, 10 }, // Efficient { nHS, pH, pS, pHS }
				{ 25, 25, 25, 25 }, // Reactive { nHS, pH, pS, pHS }
				{ 10, 10, 10, 10 }, // Aggressive { nHS, pH, pS, pHS }
				{ 10, 10, 10, 10 }, // Burn { nHS, pH, pS, pHS }
				{ 10, 10, 10, 10 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// DruidIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 25, 25, 25 }, // Balanced { nHS, pH, pS, pHS }
...
// SpellType_DOTIndex
		{
			...
			{// RangerIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 15, 15, 10, 10 }, // Balanced { nHS, pH, pS, pHS }
				{ 10, 10, 0, 0 }, // Efficient { nHS, pH, pS, pHS }
				{ 15, 15, 10, 10 }, // Reactive { nHS, pH, pS, pHS }
				{ 50, 50, 25, 25 }, // Aggressive { nHS, pH, pS, pHS }
				{ 50, 50, 25, 25 }, // Burn { nHS, pH, pS, pHS }
				{ 50, 50, 25, 25 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// ShadowknightIndex
			...
			{// DruidIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 50, 15, 50, 15 }, // Balanced { nHS, pH, pS, pHS }
				{ 25, 10, 25, 10 }, // Efficient { nHS, pH, pS, pHS }
				{ 50, 15, 50, 15 }, // Reactive { nHS, pH, pS, pHS }
				{ 50, 25, 50, 25 }, // Aggressive { nHS, pH, pS, pHS }
				{ 50, 25, 50, 25 }, // Burn { nHS, pH, pS, pHS }
				{ 50, 25, 50, 25 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// MonkIndex
			...
			{// BardIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 50, 50, 25, 25 }, // Balanced { nHS, pH, pS, pHS }
				{ 25, 25, 15, 15 }, // Efficient { nHS, pH, pS, pHS }
				{ 50, 50, 25, 25 }, // Reactive { nHS, pH, pS, pHS }
				{ 100, 100, 50, 50 }, // Aggressive { nHS, pH, pS, pHS }
				{ 100, 100, 50, 50 }, // Burn { nHS, pH, pS, pHS }
				{ 100, 100, 50, 50 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// RogueIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Balanced { nHS, pH, pS, pHS }
			...
			{// ShamanIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 15, 15, 0 }, // Balanced { nHS, pH, pS, pHS }
				{ 15, 10, 10, 0 }, // Efficient { nHS, pH, pS, pHS }
				{ 25, 15, 15, 0 }, // Reactive { nHS, pH, pS, pHS }
				{ 50, 25, 50, 15 }, // Aggressive { nHS, pH, pS, pHS }
				{ 50, 25, 50, 15 }, // Burn { nHS, pH, pS, pHS }
				{ 50, 25, 50, 15 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// NecromancerIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 }, // Balanced { nHS, pH, pS, pHS }
				...
				{ 50, 50, 50, 50 }, // Reactive { nHS, pH, pS, pHS }
				{ 50, 50, 50, 50 }, // Aggressive { nHS, pH, pS, pHS }
				{ 75, 75, 75, 75 }, // Burn { nHS, pH, pS, pHS }
				{ 75, 75, 75, 75 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// WizardIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Balanced { nHS, pH, pS, pHS }
			...
			{// EnchanterIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 50, 50, 15, 15 }, // Balanced { nHS, pH, pS, pHS }
				{ 25, 25, 10, 10 }, // Efficient { nHS, pH, pS, pHS }
				{ 50, 50, 15, 15 }, // Reactive { nHS, pH, pS, pHS }
				{ 15, 15, 25, 25 }, // Aggressive { nHS, pH, pS, pHS }
				{ 15, 15, 25, 25 }, // Burn { nHS, pH, pS, pHS }
				{ 15, 15, 25, 25 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// BeastlordIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 15, 15, 10, 10 }, // Balanced { nHS, pH, pS, pHS }
...
// SpellType_InCombatBuffIndex
		{
			...
			{// ShamanIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 50, 75, 50, 75 }, // Balanced { nHS, pH, pS, pHS }
				{ 25, 50, 25, 50 }, // Efficient { nHS, pH, pS, pHS }
				{ 50, 75, 50, 75 }, // Reactive { nHS, pH, pS, pHS }
				{ 75, 100, 75, 100 }, // Aggressive { nHS, pH, pS, pHS }
				{ 75, 100, 75, 100 }, // Burn { nHS, pH, pS, pHS }
				{ 75, 100, 75, 100 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// NecromancerIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Balanced { nHS, pH, pS, pHS }
...
// SpellType_SlowIndex
		{
			...
			{// BardIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 25, 25, 100, 100 }, // Balanced { nHS, pH, pS, pHS }
				{ 15, 15, 100, 100 }, // Efficient { nHS, pH, pS, pHS }
				{ 25, 25, 100, 100 }, // Reactive { nHS, pH, pS, pHS }
				{ 0, 0, 50, 50 }, // Aggressive { nHS, pH, pS, pHS }
				{ 0, 0, 50, 50 }, // Burn { nHS, pH, pS, pHS }
				{ 0, 0, 50, 50 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// RogueIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Balanced { nHS, pH, pS, pHS }
			...
			{// ShamanIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 50, 50, 100, 100 }, // Balanced { nHS, pH, pS, pHS }
				{ 25, 25, 100, 100 }, // Efficient { nHS, pH, pS, pHS }
				{ 50, 50, 100, 100 }, // Reactive { nHS, pH, pS, pHS }
				{ 15, 15, 50, 50 }, // Aggressive { nHS, pH, pS, pHS }
				{ 15, 15, 50, 50 }, // Burn { nHS, pH, pS, pHS }
				{ 15, 15, 50, 50 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// NecromancerIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 0, 0, 0, 0 }, // Balanced { nHS, pH, pS, pHS }
...
// SpellType_CureIndex
		{
			...
			{// BardIndex
				{ 0, 0, 0, 0 }, // Passive { nHS, pH, pS, pHS }
				{ 75, 75, 75, 75 }, // Balanced { nHS, pH, pS, pHS }
				{ 75, 75, 75, 75 }, // Efficient { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 }, // Reactive { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 }, // Aggressive { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 }, // Burn { nHS, pH, pS, pHS }
				{ 100, 100, 100, 100 } // BurnAE { nHS, pH, pS, pHS }
			},
			{// RogueIndex
...
// SpellType_OutOfCombatBuffSongIndex
	...
	return spell_casting_chances[spell_type_index][class_index][stance_index][type_index];
}
