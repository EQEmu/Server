...
int command_init(void)
{
	...
	if (
		...
		command_add("getplayerburiedcorpsecount", "- Get you or your target's total number of buried player corpses.", AccountStatus::GMAdmin, command_getplayerburiedcorpsecount) ||
