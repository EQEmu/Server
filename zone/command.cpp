...
int command_init(void)
{
	...
	if (
		...
		command_add("raidgroupsay", "Send a Raid Group Say Packet", AccountStatus::Player, command_raidgroupsay) ||
		command_add("raidsay", "Send a Raid Say Packet", AccountStatus::Player, command_raidsay) ||
