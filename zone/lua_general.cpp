...
std::string lua_get_skill_name(uint16 skill_id) {
...
luabind::scope lua_register_skills() {
	return luabind::class_<Skills>("Skill")
		.enum_("constants")
		[(
			luabind::value("1HBlunt", Skill::OneHandBlunt),
			luabind::value("Blunt1H", Skill::OneHandBlunt),
			luabind::value("1HSlashing", Skill::OneHandSlashing),
			luabind::value("Slashing1H", Skill::OneHandSlashing),
			luabind::value("2HBlunt", Skill::TwoHandBlunt),
			luabind::value("Blunt2H", Skill::TwoHandBlunt),
			luabind::value("2HSlashing", Skill::TwoHandSlashing),
			luabind::value("Slashing2H", Skill::TwoHandSlashing),
			luabind::value("Abjuration", Skill::Abjuration),
			luabind::value("Alteration", Skill::Alteration),
			luabind::value("ApplyPoison", Skill::ApplyPoison),
			luabind::value("Archery", Skill::Archery),
			luabind::value("Backstab", Skill::Backstab),
			luabind::value("BindWound", Skill::BindWound),
			luabind::value("Bash", Skill::Bash),
			luabind::value("Block", Skill::Block),
			luabind::value("BrassInstruments", Skill::BrassInstruments),
			luabind::value("Channeling", Skill::Channeling),
			luabind::value("Conjuration", Skill::Conjuration),
			luabind::value("Defense", Skill::Defense),
			luabind::value("Disarm", Skill::Disarm),
			luabind::value("DisarmTraps", Skill::DisarmTraps),
			luabind::value("Divination", Skill::Divination),
			luabind::value("Dodge", Skill::Dodge),
			luabind::value("DoubleAttack", Skill::DoubleAttack),
			luabind::value("DragonPunch", Skill::DragonPunch),
			luabind::value("TailRake", Skill::TailRake),
			luabind::value("DualWield", Skill::DualWield),
			luabind::value("EagleStrike", Skill::EagleStrike),
			luabind::value("Evocation", Skill::Evocation),
			luabind::value("FeignDeath", Skill::FeignDeath),
			luabind::value("FlyingKick", Skill::FlyingKick),
			luabind::value("Forage", Skill::Forage),
			luabind::value("HandtoHand", Skill::HandToHand),
			luabind::value("Hide", Skill::Hide),
			luabind::value("Kick", Skill::Kick),
			luabind::value("Meditate", Skill::Meditate),
			luabind::value("Mend", Skill::Mend),
			luabind::value("Offense", Skill::Offense),
			luabind::value("Parry", Skill::Parry),
			luabind::value("PickLock", Skill::PickLock),
			luabind::value("1HPiercing", Skill::OneHandPiercing),
			luabind::value("Piercing1H", Skill::OneHandPiercing),
			luabind::value("Riposte", Skill::Riposte),
			luabind::value("RoundKick", Skill::RoundKick),
			luabind::value("SafeFall", Skill::SafeFall),
			luabind::value("SenseHeading", Skill::SenseHeading),
			luabind::value("Singing", Skill::Singing),
			luabind::value("Sneak", Skill::Sneak),
			luabind::value("SpecializeAbjure", Skill::SpecializeAbjuration),
			luabind::value("SpecializeAlteration", Skill::SpecializeAlteration),
			luabind::value("SpecializeConjuration", Skill::SpecializeConjuration),
			luabind::value("SpecializeDivination", Skill::SpecializeDivination),
			luabind::value("SpecializeEvocation", Skill::SpecializeEvocation),
			luabind::value("PickPockets", Skill::PickPockets),
			luabind::value("StringedInstruments", Skill::StringedInstruments),
			luabind::value("Swimming", Skill::Swimming),
			luabind::value("Throwing", Skill::Throwing),
			luabind::value("TigerClaw", Skill::TigerClaw),
			luabind::value("Tracking", Skill::Tracking),
			luabind::value("WindInstruments", Skill::WindInstruments),
			luabind::value("Fishing", Skill::Fishing),
			luabind::value("MakePoison", Skill::MakePoison),
			luabind::value("Tinkering", Skill::Tinkering),
			luabind::value("Research", Skill::Research),
			luabind::value("Alchemy", Skill::Alchemy),
			luabind::value("Baking", Skill::Baking),
			luabind::value("Tailoring", Skill::Tailoring),
			luabind::value("SenseTraps", Skill::SenseTraps),
			luabind::value("Blacksmithing", Skill::Blacksmithing),
			luabind::value("Fletching", Skill::Fletching),
			luabind::value("Brewing", Skill::Brewing),
			luabind::value("AlcoholTolerance", Skill::AlcoholTolerance),
			luabind::value("Begging", Skill::Begging),
			luabind::value("JewelryMaking", Skill::JewelryMaking),
			luabind::value("Pottery", Skill::Pottery),
			luabind::value("PercussionInstruments", Skill::PercussionInstruments),
			luabind::value("Intimidation", Skill::Intimidation),
			luabind::value("Berserking", Skill::Berserking),
			luabind::value("Taunt", Skill::Taunt),
			luabind::value("Frenzy", Skill::Frenzy),
			luabind::value("RemoveTraps", Skill::RemoveTraps),
			luabind::value("TripleAttack", Skill::TripleAttack),
			luabind::value("2HPiercing", Skill::TwoHandPiercing),
			luabind::value("Piercing2H", Skill::TwoHandPiercing),
			luabind::value("HIGHEST_SKILL", Skill::Max)
		)];
}
