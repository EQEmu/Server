...
luabind::scope lua_register_general() {
	...
	[
		...
		luabind::def("has_timer", (void(*)(const char*, int))&lua_has_timer),
		luabind::def("get_remaining_time", (void(*)(const char*, int))&lua_get_remaining_time),
		luabind::def("get_timer_duration", (void(*)(const char*, int))&lua_get_timer_duration),
