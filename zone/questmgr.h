...
public:
	...
	void WorldWideDialogueWindow(const char* message, uint8 min_status = EQ::constants::AccountStatus::Player, uint8 max_status = EQ::constants::AccountStatus::Player);
	void WorldWideLDoNUpdate(uint8 update_type, uint32 theme_id, int points = 1, uint8 min_status = EQ::constants::AccountStatus::Player, uint8 max_status = EQ::constants::AccountStatus::Player);
	void WorldWideMarquee(uint32 type, uint32 priority, uint32 fade_in, uint32 fade_out, uint32 duration, const char* message, uint8 min_status = EQ::constants::AccountStatus::Player, uint8 max_status = EQ::constants::AccountStatus::Player);
	void WorldWideMessage(uint32 type, const char* message, uint8 min_status = EQ::constants::AccountStatus::Player, uint8 max_status = EQ::constants::AccountStatus::Player);
	void WorldWideMove(uint8 update_type, const char* zone_short_name, uint16 instance_id = 0, uint8 min_status = EQ::constants::AccountStatus::Player, uint8 max_status = EQ::constants::AccountStatus::Player);
	void WorldWideSetEntityVariable(uint8 update_type, const char* variable_name, const char* variable_value, uint8 min_status = EQ::constants::AccountStatus::Player, uint8 max_status = EQ::constants::AccountStatus::Player);
	void WorldWideSignal(uint8 update_type, uint32 signal, uint8 min_status = EQ::constants::AccountStatus::Player, uint8 max_status = EQ::constants::AccountStatus::Player);
	void WorldWideSpell(uint8 update_type, uint32 spell_id, uint8 min_status = EQ::constants::AccountStatus::Player, uint8 max_status = EQ::constants::AccountStatus::Player);
	void WorldWideTaskUpdate(uint8 update_type, uint32 task_identifier, int task_subidentifier = -1, int update_count = 1, bool enforce_level_requirement = false, uint8 min_status = EQ::constants::AccountStatus::Player, uint8 max_status = EQ::constants::AccountStatus::Player);
