...
{
	if (helper_command_alias_fail(c, "bot_command_heal_rotation_adaptive_targeting", sep->arg[0], "healrotationadaptivetargeting"))
		return;
...
{
	if (helper_command_alias_fail(c, "bot_command_heal_rotation_adjust_critical", sep->arg[0], "healrotationadjustcritical"))
		return;
	if (helper_is_help_or_usage(sep->arg[1])) {
...
{
	if (helper_command_alias_fail(c, "bot_command_heal_rotation_casting_override", sep->arg[0], "healrotationcastingoverride"))
		return;
	if (helper_is_help_or_usage(sep->arg[1])) {
		c->Message(Chat::White, "usage: (<target_member>) %s ([member_name]) ([option: on | off])", sep->arg[0]);
		return;
...
{
	if (helper_command_alias_fail(c, "bot_command_heal_rotation_change_interval", sep->arg[0], "healrotationchangeinterval"))
		return;
	if (helper_is_help_or_usage(sep->arg[1])) {
...
{
	if (helper_command_alias_fail(c, "bot_command_heal_rotation_clear_targets", sep->arg[0], "healrotationcleartargets"))
		return;
	if (helper_is_help_or_usage(sep->arg[1])) {
		c->Message(Chat::White, "usage: (<target_member>) %s ([member_name])", sep->arg[0]);
		return;
...
{
	if (helper_command_alias_fail(c, "bot_command_heal_rotation_remove_member", sep->arg[0], "healrotationremovemember"))
		return;
	if (helper_is_help_or_usage(sep->arg[1])) {
		c->Message(Chat::White, "usage: (<target_member>) %s ([member_name])", sep->arg[0]);
		return;
...
{
	if (helper_command_alias_fail(c, "bot_command_heal_rotation_remove_target", sep->arg[0], "healrotationremovetarget"))
		return;
	if (helper_is_help_or_usage(sep->arg[1])) {
		c->Message(Chat::White, "usage: (<target_member>) %s [heal_target_name] ([member_name])", sep->arg[0]);
		return;
...
{
	if (helper_command_alias_fail(c, "bot_command_heal_rotation_reset_limits", sep->arg[0], "healrotationresetlimits"))
		return;
	if (helper_is_help_or_usage(sep->arg[1])) {
		c->Message(Chat::White, "usage: (<target_member>) %s ([member_name])", sep->arg[0]);
		return;
