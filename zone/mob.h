...
public:
	...
	virtual bool SpellEffect(Mob* caster, uint16 spell_id, float partial = 100, int level_override = -1, int32 duration_override = 0);
	...
	int32 GetVirusBuffDuration(int32 spell_id);
