...
public:
	...
	int GetRaceBitmask();
	int GetBaseFace();
	int GetLanguageSkill(uint16 skill_id);
	...
	bool TGB();
	int GetSkillPoints();
	void SetSkillPoints(uint16 skill_id);
	void IncreaseSkill(uint16 skill_id);
	void IncreaseSkill(uint16 skill_id, int value);
	void IncreaseLanguageSkill(uint8 language_id);
	void IncreaseLanguageSkill(uint8 language_id, uint8 increase);
	int GetRawSkill(uint16 skill_id);
	bool HasSkill(uint16 skill_id);
	bool CanHaveSkill(uint16 skill_id);
	void SetSkill(uint16 skill_id, int value);
	void AddSkill(uint16 skill_id, int value);
	void CheckSpecializeIncrease(int spell_id);
	void CheckIncreaseSkill(uint16 skill_id, Lua_Mob target);
	void CheckIncreaseSkill(uint16 skill_id, Lua_Mob target, int chance_mod);
	void SetLanguageSkill(uint8 language_id, uint8 language_skill);
	int MaxSkill(uint16 skill_id);
	bool IsMedding();
	int GetDuelTarget();
	bool IsDueling();
	...
	uint8 GetSkillTrainLevel(uint16 skill_id);
