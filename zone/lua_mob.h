...
public:
	...
	void Damage(Lua_Mob from, int64 damage, int spell_id, uint16_t attack_skill);
	void Damage(Lua_Mob from, int64 damage, int spell_id, uint16_t attack_skill, bool avoidable);
	void Damage(Lua_Mob from, int64 damage, int spell_id, uint16_t attack_skill, bool avoidable, int buffslot);
	void Damage(Lua_Mob from, int64 damage, int spell_id, uint16_t skill_id, bool avoidable, int buffslot, bool buff_tic);
	...
	void DoSpecialAttackDamage(Lua_Mob other, uint16 skill_id, int max_damage);
	void DoSpecialAttackDamage(Lua_Mob other, uint16 skill_id, int max_damage, int min_damage);
	void DoSpecialAttackDamage(Lua_Mob other, uint16 skill_id, int max_damage, int min_damage, int hate_override);
	void DoSpecialAttackDamage(Lua_Mob other, uint16 skill_id, int max_damage, int min_damage, int hate_override, int reuse_time);
	...
	void DoMeleeSkillAttackDmg(Lua_Mob other, int weapon_damage, uint16 skill_id);
	void DoMeleeSkillAttackDmg(Lua_Mob other, int weapon_damage, uint16 skill_id, int chance_mod);
	void DoMeleeSkillAttackDmg(Lua_Mob other, int weapon_damage, uint16 skill_id, int chance_mod, int focus);
	void DoMeleeSkillAttackDmg(Lua_Mob other, int weapon_damage, uint16 skill_id, int chance_mod, int focus, bool can_riposte);
	...
	int GetModSkillDmgTaken(uint16 skill_id);
	int GetSkillDmgTaken(uint16 skill_id);
