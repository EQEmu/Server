...
void perl_register_zone()
{
	...
	package.add("GetFogBlue", &Perl_Zone_GetFogBlue);
	package.add("GetFogDensity", &Perl_Zone_GetFogDensity);
	package.add("GetFogGreen", &Perl_Zone_GetFogGreen);
	package.add("GetFogMaximumClip", &Perl_Zone_GetFogMaximumClip);
	package.add("GetFogMinimumClip", &Perl_Zone_GetFogMinimumClip);
	package.add("GetFogRed", &Perl_Zone_GetFogRed);
	...
	package.add("GetRainChance", &Perl_Zone_GetRainChance);
	package.add("GetRainDuration", &Perl_Zone_GetRainDuration);
	...
	package.add("GetSnowChance", &Perl_Zone_GetSnowChance);
	package.add("GetSnowDuration", &Perl_Zone_GetSnowDuration);
