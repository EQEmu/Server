...
// All allocated BotCommandRecords get put in here and deleted on shutdown
...
int bot_command_init(void)
{
	...
	if (
		...
		bot_command_add("bothairstyle", "Changes the hairstyle of a bot", AccountStatus::Player, bot_command_hair_style) ||
		...
		bot_command_add("botlist", "Lists the bots that you own", AccountStatus::Player, bot_command_list_) ||
...
#include "bot_commands/portal.cpp"
...
#include "bot_commands/spawn.cpp"
...
#include "bot_commands/title.cpp"
