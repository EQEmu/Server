...
public:
	...
	int64 CommonDamage(Mob *self, Mob* attacker, int64 value, uint16 spell_id, uint16 skill_id, bool avoidable, int8 buff_slot, bool buff_tic, int special, bool &ignore_default);
