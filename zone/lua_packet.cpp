...
luabind::scope lua_register_packet_opcodes() {
	return luabind::class_<Opcodes>("Opcode")
		...
		[
			...
			luabind::value("AddNimbusEffect", static_cast<int>(OP_AddNimbusEffect)),
			...
			luabind::value("AggroMeterLockTarget", static_cast<int>(OP_AggroMeterLockTarget)),
			luabind::value("AggroMeterTargetInfo", static_cast<int>(OP_AggroMeterTargetInfo)),
			luabind::value("AggroMeterUpdate", static_cast<int>(OP_AggroMeterUpdate)),
			...
			luabind::value("CancelSneakHide", static_cast<int>(OP_CancelSneakHide)),
			...
			luabind::value("ClearAA", static_cast<int>(OP_ClearAA)),
			luabind::value("ClearBlockedBuffs", static_cast<int>(OP_ClearBlockedBuffs)),
			luabind::value("ClearLeadershipAbilities", static_cast<int>(OP_ClearLeadershipAbilities)),
			...
			luabind::value("GroupMentor", static_cast<int>(OP_GroupMentor)),
			...
			luabind::value("GuildBankItemList", static_cast<int>(OP_GuildBankItemList)),
			...
			luabind::value("InspectBuffs", static_cast<int>(OP_InspectBuffs)),
			...
			luabind::value("ItemRecastDelay", static_cast<int>(OP_ItemRecastDelay)),
			...
			luabind::value("KickPlayers", static_cast<int>(OP_KickPlayers)),
			...
			luabind::value("LinkedReuse", static_cast<int>(OP_LinkedReuse)),
			...
			luabind::value("MoveMultipleItems", static_cast<int>(OP_MoveMultipleItems)),
			...
			luabind::value("PetCommandState", static_cast<int>(OP_PetCommandState)),
			luabind::value("PetHoTT", static_cast<int>(OP_PetHoTT)),
			...
			luabind::value("QueryUCSServerStatus", static_cast<int>(OP_QueryUCSServerStatus)),
			...
			luabind::value("RemoveTrap", static_cast<int>(OP_RemoveTrap)),
			...
			luabind::value("UpdateAura", static_cast<int>(OP_UpdateAura)),
			...
			luabind::value("XTargetOpen", static_cast<int>(OP_XTargetOpen)),
			luabind::value("XTargetOpenResponse", static_cast<int>(OP_XTargetOpenResponse)),
			...
			luabind::value("ResetAA", static_cast<int>(OP_ResetAA))
		];
}
