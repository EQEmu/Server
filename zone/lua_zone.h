...
public:
	...
	uint8 GetFogBlue(uint8 slot = 0);
	float GetFogDensity();
	uint8 GetFogGreen(uint8 slot = 0);
	float GetFogMaximumClip(uint8 slot = 0);
	float GetFogMinimumClip(uint8 slot = 0);
	uint8 GetFogRed(uint8 slot = 0);
	...
	int8 GetPEQZone();
	int GetRainChance(uint8 slot = 0);
	int GetRainDuration(uint8 slot = 0);
	uint32 GetRuleSet();
	...
	uint8 GetSky();
	int8 GetSkyLock();
	int GetSnowChance(uint8 slot = 0);
	int GetSnowDuration(uint8 slot = 0);
	uint8 GetTimeType();
	int GetTimeZone();
