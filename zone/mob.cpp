...
void Mob::SendAppearancePacket(uint32 type, uint32 value, bool WholeZone, bool iIgnoreSelf, Client *specific_target, bool whole_zone_minus_my_guild) {
	if (!GetID())
		return;
