...
public:
	...
	void	CLEAdd(uint32 iLSID, const char* iLoginServerName, const char* iLoginName, const char* iLoginKey, int16 iWorldAdmin = EQ::constants::AccountStatus::Player, uint32 ip = 0, uint8 local=0);
